const tripRequestTemplate = (data) => {
  ...
  <body>
    <span class="preheader">New trip request: </span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <p>Please <a href="mailto:wolfsbane@gmail.com">contact support</a> if you have questions.</p>
                        ...
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">If you’re having trouble with the buttons above, copy and paste the URL below into your web browser.</p>
...
export default tripRequestTemplate;
